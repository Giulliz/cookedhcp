...
pub const CIADDR_START: usize = 40 - PAYLOAD_OFFSET;
pub const YIADDR_START: usize = 44 - PAYLOAD_OFFSET;
pub const SIADDR_START: usize = 48 - PAYLOAD_OFFSET;
pub const GIADDR_START: usize = 52 - PAYLOAD_OFFSET;
